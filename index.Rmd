...
```
Call:
lm(formula = PMtrans ~ sqrt(PGSI), data = DSC[-c(76, 108, 146, 
    101, 125, 149), ])

Residuals:
     Min       1Q   Median       3Q      Max 
-2.41516 -0.67968  0.00689  0.70311  2.15260 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  2.84740    0.11337  25.115  < 2e-16 ***
sqrt(PGSI)  -0.20564    0.05841  -3.521 0.000541 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 1.03 on 187 degrees of freedom
Multiple R-squared:  0.06216,	Adjusted R-squared:  0.05714 
F-statistic: 12.39 on 1 and 187 DF,  p-value: 0.0005409
...
```{r include=FALSE}
scatterplot(SM ~ PGSI, data = DSC, col= "black", xlab = "Gambling Severity", ylab = "Meaning Seeking", legend = TRUE)
...
ggplot(DSC, aes(x = PGSI, y = SM, color = GP)) +
  ...
  labs(title = "Interaction Plot: Gambling Severity and Gambling Pathway on Meaning Seeking", x = "Gambling Severity", y = "Meaning Seeking", color = "Gambling Pathway") +theme_apa(box = TRUE)
```
